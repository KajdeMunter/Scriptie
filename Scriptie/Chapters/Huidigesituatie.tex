...
Het EMS is één enkele Symfony applicatie, waar voor de frontend gebruik wordt gemaakt van de templating engine \enquote{Twig}

Voor de 15-Factor App geldt Factor 1 \textbf{(One codebase, one application)}, 3 \textbf{(Dependency management)} en 8 \textbf{(Backing services)}.
...
Voor de 15-Factor app geldt Factor 4 \textbf{(Design, build, release and run)}, 9 \textbf{(Environment parity)} en 11 \textbf{(Port binding)}.
...
\textcolor{red}{TODO: Hoe te meten?} % TODO: Hoe te meten?
