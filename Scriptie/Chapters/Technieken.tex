...
De definitie van load scalability luidt als volgt: \enquote{Het vermogen van een systeem om elegant te presteren naarmate het aangeboden verkeer toeneemt}. Om dit te verbeteren zijn de volgende technieken beschikbaar: \textcolor{red}{TODO: Technieken voor load scalability}

\enquote{container orchestration} tools helpen bij het automatiseren van alle aspecten behorend bij het beheren van containers.
