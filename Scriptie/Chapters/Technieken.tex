...
Momenteel worden de applicaties binnen Developers.nl gehost op een simpele server van Mijndomein. Een overweging om te maken is of dit niet beter naar een cloud service provider kan worden verplaatst. Om te overwegen of een cloud provider bij de wensen van Developers.nl past worden de voor-en nadelen op een rijtje gezet:

\textbf{Voordelen cloud provider:} blabla

\textbf{Voordelen traditionele server:} blabla

\textbf{Nadelen cloud provider:} blabla

\textbf{Nadelen traditionele server:} blabla
