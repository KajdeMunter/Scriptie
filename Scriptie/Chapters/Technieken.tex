...
\textbf{Nadelen traditioneel:} De mogelijkheid bestaat dat er meer kosten worden gemaakt dan nodig is. Ook is shared hosting een risico omdat zodra een andere klant veel rekenkracht opeist de kans omstaat dat de prestaties dalen.

\section{Serverless}
Omdat het EMS zo weinig wordt gebruikt is het mogelijk dat \enquote{serverless computing} een zeer kostenbesparende optie kan zijn.
