...
\parencite{IEEEArchitecture}

Albin, S. T. definieert software-architectuur als \enquote{De waarneembare eigenschappen van een softwaresysteem} \parencite{ArtOfArchitecture}.Software-architectuur houdt zich bezig met het ontwerp en de implementatie van de structuur op hoog niveau \parencite{4plus1}.

Meerdere boeken nemen de definitie van \parencite{ArchitectureInPractice} als uitgangspunt \parencite{ArchitectureStakeholders, DesigningArchitectures}. Daarom zal in dit onderzoek ook gebruik gemaakt worden van deze definitie.
