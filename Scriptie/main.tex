...
\deelvraagverwachtingen{Wat verwacht Developers.nl van dit onderzoek?}
...
\deelvraaghuidig{Hoe onderhoud- en schaalbaar zijn de huidige systemen van Developers.nl met betrekking tot de relevante kwaliteitsstandaarden?}
\deelvraagverbetering{Wat voor verbeteringen ten aanzien van schaal- en onderhoudbaarheid kunnen worden toegepast op de huidige systemen van Developers.nl?}
...
\begin{samenvatting}
	\addchaptertocentry{\samenvattingname} % Add the abstract to the table of contents
