...
\usepackage[backend=bibtex,style=ieee]{biblatex} % Use bibtext and IEEE reference style
	...
	\begin{center}
		...
		\begin{minipage}[t]{0.4\textwidth}
			\begin{flushright} \large
				...
				\textbf{Jelle van de Hatert}\\
				j.vandehatert@developers.nl
			\end{flushright}
		\end{minipage}\\[2cm]
...
\include{Chapters/Vooronderzoek} 
